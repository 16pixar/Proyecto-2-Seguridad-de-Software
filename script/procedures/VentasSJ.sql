-- ============================================================
-- STORED PROCEDURES DE VENTAS - SAN JOSÉ
-- ============================================================
-- Procedimientos para gestión de ventas en sucursal San José
...
PRINT '✅ Stored Procedures de Ventas creados para SAN JOSÉ';
PRINT '';
...
PRINT '    - Sales.Invoices_SJ';
PRINT '    - Sales.InvoiceLines_SJ';
GO
