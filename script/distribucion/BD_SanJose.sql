...
BEGIN
    CREATE DATABASE WWI_SanJose;
    PRINT 'Database WWI_SanJose created.';
END
ELSE
BEGIN
    PRINT 'Database WWI_SanJose already exists.';
END
GO
...
PRINT 'Estructura de base de datos WWI_SanJose creada exitosamente.';
PRINT '';
