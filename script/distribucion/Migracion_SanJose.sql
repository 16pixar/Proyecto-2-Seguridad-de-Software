-- ============================================================
-- MIGRACIÓN DE DATOS A WWI_SANJOSE
-- ============================================================
-- Propósito: 
--   1. Migrar catálogo completo (Clientes sin sensibles, Proveedores, Productos)
--   2. Migrar 50% del inventario
--   3. Migrar 50% de las facturas (CustomerID impar)
--   4. Migrar 50% de las órdenes de compra (PurchaseOrderID impar)
-- ============================================================

USE WWI_SanJose;
GO

PRINT 'Iniciando migración de datos a WWI_SanJose...';
GO
...
-- ============================================================
-- 6. INVENTARIO PROPIO (50% - StockItemID impar)
-- ============================================================

PRINT 'Migrando inventario propio de SanJose (50% - IDs impares)...';
GO
...
-- ============================================================
-- 7. FACTURAS PROPIAS (50% - CustomerID impar)
-- ============================================================

PRINT 'Migrando facturas propias de SanJose (50% - CustomerID impar)...';
GO
...
-- ============================================================
-- 8. ÓRDENES DE COMPRA PROPIAS (50% - PurchaseOrderID impar)
-- ============================================================

PRINT 'Migrando órdenes de compra propias de SanJose (50% - PurchaseOrderID impar)...';
GO
...
WHERE StockItemID % 2 = 1; -- Solo transacciones de productos en nuestro inventario
...
PRINT '';
PRINT '========================================';
PRINT 'MIGRACIÓN A WWI_SANJOSE COMPLETADA';
PRINT '========================================';
PRINT '';
